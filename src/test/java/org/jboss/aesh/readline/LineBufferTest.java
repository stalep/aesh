...
public class LineBufferTest {
  ...
  public void testCursorPosition() {
    LineBuffer buffer = new LineBuffer();
    buffer.insert('a', 'b', 'c');
    assertEquals(new Point(3, 0), buffer.getCursorPosition(4));
    assertEquals(new Point(0, 1), buffer.getCursorPosition(3));
    assertEquals(new Point(1, 1), buffer.getCursorPosition(2));
    assertEquals(new Point(0, 3), buffer.getCursorPosition(1));
  }
  ...
  public void testCursorPositionWithNewLine() {
    LineBuffer buffer = new LineBuffer();
    buffer.insert('a', 'b', '\n', 'c');
    assertEquals(new Point(1, 1), buffer.getCursorPosition(4));
    assertEquals(new Point(1, 1), buffer.getCursorPosition(3));
    assertEquals(new Point(1, 2), buffer.getCursorPosition(2));
    assertEquals(new Point(0, 4), buffer.getCursorPosition(1));
  }
  ...
  public void testCursorPositionWithCR() {
    ...
    assertEquals(new Point(2, 0), buffer.getCursorPosition(4));
    assertEquals(new Point(2, 0), buffer.getCursorPosition(3));
    assertEquals(new Point(0, 1), buffer.getCursorPosition(2));
    assertEquals(new Point(0, 3), buffer.getCursorPosition(1));
  }
  ...
  public void testCursorControlChar() {
    ...
    assertEquals(new Point(2, 0), buffer.getCursorPosition(3));
    assertEquals(new Point(0, 1), buffer.getCursorPosition(2));
    assertEquals(new Point(0, 2), buffer.getCursorPosition(1));
  }
  ...
  public void testCursorPositionWithMultiCell2() {
    ...
    assertEquals(new Point(3, 0), buffer.getCursorPosition(4));
    assertEquals(new Point(0, 1), buffer.getCursorPosition(3));
    assertEquals(new Point(0, 2), buffer.getCursorPosition(2));
    try {
      buffer.getCursorPosition(1);
      fail();
    } catch (UnsupportedOperationException ignore) {
