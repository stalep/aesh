...
public class Readline {
  ...
  public class Interaction {
    ...
    void resize(int oldWith, int newWidth) {
      ...
      Size pos = abc.getCursorPosition(newWidth);
      int curWidth = pos.getWidth();
      int curHeight = pos.getHeight();

      // Recompute new end
      Size end = abc.getPosition(abc.getSize(), oldWith);
      int endHeight = end.getHeight() + end.getWidth() / newWidth;
